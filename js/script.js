window.onload = function() {
    ...
    var days = [{
        "day": 0,
        "score": 30,
        "instruction": "<p>You are on a pendingfi!<br>While waiting try to survive the 5 days fishing trip.<br>You need to get a certain score to proceed to the next day</p><p>Happy fishing!</p>"
    },{
        "day": 1,
        "score": 40,
        "instruction": "You can catch big blubfish now.<br>They are fast, so be ready!"
    },{
        "day": 2,
        "score": 50,
        "instruction": "Lately, more trash are found in the blub ocean.<br>There is penalty if you catch some.<br> Let's continue and avoid the trash!"
    },{
        "day": 3,
        "score": 60,
        "instruction": "Jellyfishes have invaded this blub ocean region.<br>You will get stunned if you catch them<br>Let's continue and avoid getting stunned by them!"
    },{
        "day": 4,
        "score": 75,
    ...
    function endDay(died) {
        ...
        if (!died) {
            ...
            if (day < 5) {
                ...
                instructions.innerHTML = `<h2>You have finished the entire week!</h2><p>You have caught ${fishTracker[0]} blub, ${fishTracker[1]} big blub, ${fishTracker[2]} trash and ${fishTracker[2]} jellyfishes.<br>Your Total Score: ${score}</p>`;
                day=0;
            }
